...
keep_gene <- c("SHC1","AKT3", "NEDD9","ESR1","EGFR", "PPP2R2A","MYC", "CDKN2A", "GATA3","CCND1","PGR", 
               "CDK4","FOXA1","TP53", "ERBB2", "BRCA1", "BCL2","AURKA")
keep_gene2 <- c("ESR1","CCNE2", "MYC", "CDKN2A", "BRCA2","RB1","PPM1D", "BCL2","CCNE1","AURKA")
